 ...
 *                           :   00050000H - 0006FFFFH   128K
 *                       DATA:   20003800H - 200047FFH     4K
 *
 * note:
 *  CH57xBLE_ROM.hex   #define LIB_FLASH_BASE_ADDRESSS   0x00010000(default)
 *  CH57xBLE_ROMx.hex  #define LIB_FLASH_BASE_ADDRESSS   0x00050000
...
typedef struct tag_rf_config
{
    ...
    uint8_t HopPeriod;               //!< hop period( T=n*32 RTC clock ),default is 8
...
#define LIB_FLASH_BASE_ADDRESSS   0x00050000//0x00010000 //0x00050000
#endif
#define LIB_FLASH_MAX_SIZE        0x00020000

#define RAM_BASE_ADDRESSS         0x20004800
 ...
 * @return  None.
 */
#define   LL_AdvertiseEventRegister ((  void  (*) ( pfnEventCB advEventCB ))  BLE_LIB_JT(128))
 ...
 * @return  None.
 */
#define   RFEND_SetSensitivity  ((  void  (*) ( void )) BLE_LIB_JT(122) )
 ...
 * @return  Command Status.
 */
#define   RFEND_TXCtuneSet  ((  bStatus_t (*) ( uint8_t *pParm )) BLE_LIB_JT(123) )
 ...
 * @return  Command Status.
 */
#define   RFEND_TXCtuneGet  ((  bStatus_t (*) ( uint8_t *pParm )) BLE_LIB_JT(124) )
 ...
 * @return  none.
 */
#define   RFEND_SetAdcMode  ((  void (*) ( uint8_t mode )) BLE_LIB_JT(125) )
